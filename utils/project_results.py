...
# Example usage:
csv_directory = r"transfer_learning_results/csv"
save_directory = r"transfer_learning_results/graphs"
plot_from_csv(csv_directory, save_directory, 'loss')

# Example usage:
file_path = r"transfer_learning_results/csv"
save_path = r"transfer_learning_results/graphs"
